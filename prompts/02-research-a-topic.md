...
1. `node aim-lt.js info` once, to get the real topic names and limits.
...
3. Check `total` in the response so you know whether you are looking at 3 messages or 300.
